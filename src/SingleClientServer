...
public class Server
{
   ...
   //     System.out.println(Directory_Name);
        ...
        try
        {
            ...
            System.out.println("Just Connected to "+s.getLocalPort());
           ...
           /* for(int i=0;i<Method_Path.length;i++)
            {
                System.out.println(Method_Path[i]);
            }*/
          ...
          //while(!((temp=in2.readLine())==null))
           ...
           // System.out.println("Payload data is: "+payload.toString());
            ...
            System.out.println("Content-Type is here-: "+Content_Type);
 ...
 //          System.out.println("Array length is " +strArray.length);
   /*         for(int i=0;i<strArray.length;i++)
          ...
          //  PrintWriter out = new PrintWriter(new BufferedWriter(new OutputStreamWriter(s.getOutputStream())),true);
           ...
           out.writeBytes("Server: Navjot/0.1\r\n");
...
//          out.writeBytes("Content-Disposition: attachment; filename=nav.txt\r\n");
          ...
          //  headers.put("\r\n");
           // Response.put("Headers",headers);
            ...
            //Response.put("Server: ","Navjot/0.1");
            //Response.put("Expires: ","Sat, 01 Jan 2020 00:59:59 GMT");
            // out.write("<TITLE>Exemple</TITLE>");
            // out.write("<P>Server exemple.</P>");
            // out.write("\r\n");
            //Body part of http
            if(Method.equalsIgnoreCase("GET"))
                {
                    System.out.println("Path is here "+Path_Requested_File);
                  if (Path_Requested_File.equalsIgnoreCase("/"))
                   {
